...
function Home() {
  return (
    <div className='w-full min-h-screen flex flex-col py-10 bg-purple-600 justify-center items-center'>
      ...
      <section className='w-full min-h-[70vh] bg-background-600 '>
      <HoverCards/>
      </section>


      <section className='w-full min-h-screen bg-background-600 '>
            <h3 className='text-[2vw] font-bold text-white  text-center pt-10'>Full-scale protection from cyberthreats</h3>
            <p className='text-white text-center w-2/5 mx-auto mt-4'>Comprehensive cybersecurity solutions safeguarding your digital assets. Stay protected against evolving threats with our advanced defense systems.</p>
    ...
    className='flex flex-col justify-center items-center h-[50vh] w-full bg-cover bg-center text-background-200 relative mt-16'>
          <h1 className='text-[4vw] font-bold  z-20'>Your Online activity & privacy covered</h1>

          <p className=' text-center w-2/5 mx-auto mt-4'>Our comprehensive cybersecurity solutions are designed to protect your digital assets from evolving threats. </p>
      </div>
